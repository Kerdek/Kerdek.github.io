...
const baba_monarch_tokens: IMonarchLanguage = {
  brackets: [
...
const baba_language_config: LanguageConfiguration = {
  comments: {
    lineComment: "//",
    blockComment: ["/*", "*/"] },
  brackets: [
...
const baba_editor_config: IStandaloneEditorConstructionOptions = {
...
const baba_theme: IStandaloneThemeData = {
...
const button: Button = (text, title, action) => create_element('div',
  function () {
    ...
    this.addEventListener('mouseenter', () =>
      this.style.color = playground_colors.punct)
