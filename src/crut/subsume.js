    ...
    const o = homproc((call, ret) => {
        ...
        const q = (l, r) => () => !r[0] ? ret(empty_inequalities()) :
            !l[0] ? ret(`Not enough tuple elements.`) :
                call(s(l[0], r[0]), vars => typeof vars === "string" ? ret(vars) :
                    call(q(l.slice(1), r.slice(1)), rest => typeof rest === "string" ? ret(rest) :
                        ret(conjoin_inequalities(vars, rest))));
        const s = (l, r) => () => call(() => di(m.get(l), dl => dl ?
            di(dl.get(r), dr => dr ? ret(dr) : (dl.set(r, empty_inequalities()),
                        ...
                        r.kind === aka ? jmp(s(l, r.identity)) :
                            l.kind === ref && r.kind === ref ?
                                l.name === r.name ? ret(empty_inequalities()) :
                                    di(l, dl => typeof dl === "string" ? ret(dl) :
                                        di(r, dr => typeof dr === "string" ? ret(dr) :
                                        ...
                                        l.kind === num && r.kind === num ? ret(empty_inequalities()) :
                                            l.kind === str && r.kind === str ? ret(empty_inequalities()) :
                                                l.kind === bol && r.kind === bol ? ret(empty_inequalities()) :
                                                    l.kind === dsj ?
                                                        call(s(l.lhs, r), da => typeof da === "string" ? ret(`\`${print_type(l)}\` does not subsume \`${print_type(r)}\`.\n${da}`) :
                                                            call(s(l.rhs, r), db => typeof db === "string" ? ret(`\`${print_type(l)}\` does not subsume \`${print_type(r)}\`.\n${db}`) :
                                                                ret(conjoin_inequalities(da, db)))) :
                                                        r.kind === cnj ?
                                                            call(s(l, r.lhs), da => typeof da === "string" ? ret(`\`${print_type(l)}\` does not subsume \`${print_type(r)}\`.\n${da}`) :
                                                                call(s(l, r.rhs), db => typeof db === "string" ? ret(`\`${print_type(l)}\` does not subsume \`${print_type(r)}\`.\n${db}`) :
                                                                    ret(conjoin_inequalities(da, db)))) :
                                                            l.kind === cnj ?
                                                                call(s(l.lhs, r), da => typeof da === "string" ?
                                                                    call(s(l.rhs, r), db => typeof db === "string" ? ret(`\`${print_type(l)}\` does not subsume \`${print_type(r)}\`.\n${da}\n${db}`) :
                                                                        ret(db)) :
                                                                    call(s(l.rhs, r), db => typeof db === "string" ? ret(da) :
                                                                        ret(disjoin_inequalities(da, db)))) :
                                                                r.kind === dsj ?
                                                                    call(s(l, r.lhs), da => typeof da === "string" ?
                                                                        call(s(l, r.rhs), db => typeof db === "string" ? ret(`\`${print_type(l)}\` does not subsume \`${print_type(r)}\`.\n${da}\n${db}`) :
                                                                            ret(db)) :
                                                                        call(s(l, r.rhs), db => typeof db === "string" ? ret(da) :
                                                                            ret(disjoin_inequalities(da, db)))) :
                                                                    l.kind === unk ? ret(`\`${print_type(l)}\` does not subsume \`${print_type(r)}\`.`) :
                                                                        r.kind === any ? ret(`\`${print_type(l)}\` does not subsume \`${print_type(r)}\`.`) :
                                                                            l.kind === lit && (r.kind === lit && l.value === r.value ||
                                                                                        ...
                                                                                        l.kind === rec ?
                                                                                            ...
                                                                                            r.kind === abs ?
                                                                                                di(result(l, r.lhs), dr => typeof dr === "string" ? ret(`\`${print_type(l)}\` does not subsume \`${print_type(r)}\`.\n${dr}`) :
                                                                                                    call(s(dr[0], r.rhs), dy => typeof dy === "string" ? ret(`\`${print_type(l)}\` does not subsume \`${print_type(r)}\`.\n${dy}`) : (ret(conjoin_inequalities(dy, dr[1]))))) :
                                                                                                ret(`\`${print_type(l)}\` does not subsume \`${print_type(r)}\`.`);
        return s(l, r);
    });
    if (typeof o === "string")
