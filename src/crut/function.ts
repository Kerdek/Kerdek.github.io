...
import { abs, cnj, dsj, TypeTree, typ_new, ref, typ_dsj, typ_abs, typ_cnj, aka } from "./graph.js"
...
export const result: (t: TypeTree, a: TypeTree) => [TypeTree, Inequalities] | string = (t, a) => {
t = rename(typ_new, t, {})
...
t.kind === abs ?
ret(
  di(subsume(a, t.lhs), vars =>
  typeof vars === "string" ? vars :
  di(eliminate(vars, t.vars, false), soln =>
  typeof soln === "string" ? soln :
  di(substitute(soln[0], t.rhs, false), r =>
  typeof r === "string" ? r :
