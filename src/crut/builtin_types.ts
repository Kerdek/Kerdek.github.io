...
import { TypeTree, typ_ref, typ_bol, typ_cnj, typ_dsj, typ_abs, typ_iov, typ_num, typ_str, typ_unk, TypingContext, typ_ext } from './graph.js'

const typ_unary_num_num: TypeTree = typ_abs([], typ_num(), typ_num())
const typ_binary_num_num_num: TypeTree = typ_abs([], typ_num(), typ_unary_num_num)
const typ_comparison: TypeTree = typ_cnj(typ_abs([], typ_str(), typ_abs([], typ_str(), typ_bol())), typ_abs([], typ_num(), typ_abs([], typ_num(), typ_bol())))
const typ_equality: TypeTree = typ_abs([], typ_unk(), typ_abs([], typ_unk(), typ_bol()))

export const builtins_types: TypingContext = {
