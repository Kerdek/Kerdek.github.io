...
import { Vars, add_scene_changed_handler, context_menu, create_pane, remove_scene_changed_handler, scene_changed } from "./playground.js"
import { add_script_editor } from "./script_editor.js"

export const add_script_browser = (scene: Scene, global: Vars) => create_pane({}, pane => {
