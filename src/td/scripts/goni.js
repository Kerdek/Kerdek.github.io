...
export const measure_surface = (tests, bucket_divisions, sdf) => {
...
void main(void) {
  fragColor = density; }`);
    ...
    gl.readPixels(0, 0, bucket_divisions, bucket_edge, gl.RGBA, gl.FLOAT, buckets);
    return buckets;
};
//# sourceMappingURL=goni.js.map