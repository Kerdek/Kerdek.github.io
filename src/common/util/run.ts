...
export type HomStem<Result> = <RealWorld>(call: HomCall<Result, RealWorld>, cc: HomCC<Result, RealWorld>, ret: HomRet<Result, RealWorld>) => () => RealWorld

type HomProc = <Result>(e: HomStem<Result>) => Result
