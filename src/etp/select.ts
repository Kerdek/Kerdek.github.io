...
{ k: 'proposition', n: Statement, e: Proof | null, t: Proposition } |
{ k: 'binding', w: TextRange, i: Identifier, n: Statement, e: Proof | null }

export const

select_proposition = (wp: TextPosition, n: Statement, e: Proof | null) => walk_proposition_conditional<SelectResult | null>(
...
n => n.k === 'def' && select_proposition(wp, n, null)(n.d) ||
n.k === 'thm' && (
  select_proposition(wp, n, null)(n.t) ||
