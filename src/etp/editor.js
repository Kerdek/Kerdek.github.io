import { colors, mode } from "./colors.js";
...
monaco.languages.registerDocumentSemanticTokensProvider('semity', {
    ...
    provideDocumentSemanticTokens: (model, _resultId, _token) => ({
        data: new Uint32Array(read_article_tokens(tokenizer(model.getValue(), { line: 1, col: 1 })).reduce(([a, l, c], b) => (a.push(b.w.begin.line - l, b.w.begin.line === l ? b.w.begin.col - c : b.w.begin.col - 1, b.w.end.col - b.w.begin.col, token_kinds.indexOf(b.type), 0), [a, b.w.begin.line, b.w.begin.col]), [[], 1, 1])[0])
    }),
...
export const create_editor = (e) => monaco.editor.create(e, config);
